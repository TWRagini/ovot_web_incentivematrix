<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TownMaster.aspx.cs" Inherits="OVOTS_WebApp.TownMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto';margin-top:30px">Town Master</h2>
        <div style="width: 100%; ">
            ...
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px; background-color: #D8D8D8; overflow: auto">
                ...
                <table class="imagetable" id="TownMasterTbl" style="width: 100%; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                        <th style="" class='noExl'>Action</th>
                        <th style="">Town Code</th>
                        <th style="">State </th>
                ...
                <table class="imagetable" id="TownMasterTblExl" style="width: 100%; display: none; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                       <th style="">Town Code</th>
                        <th style="">State </th>
                        <th style="">District </th>
                                    ...
                                    <div class="" style="padding: 10px;">
                                        ...
                                        <div style="height: 100%">
                                            <div class="form-group; col-sm-12">
                                                <input type="hidden" id="HDTownCode" value="0" />
                                                <div class="col-sm-4">
                                                    <label>State </label>
                                             ...
                                             <div class="col-sm-4">
                                                    ...
                                                    <input type="text" class="form-control input-sm" id="TownName" maxlength="150" placeholder="Town Name" />
                                                </div>
                                                <div class="col-sm-4">
                                                    <label>Active</label>
                                                    <br>
    ...
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/Pages/TownJS.js"></script>
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/bootstrap.js"></script>
    <script>
        function ShowMsg() {
