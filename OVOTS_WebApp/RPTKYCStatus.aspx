<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RPTKYCStatus.aspx.cs" Inherits="OVOTS_WebApp.RPTKYCStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto'" runat="server" id="lblheading">KYC Status Report</h2>
    <div style="width:108%;margin-left:-50px">
        <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px">
             <div class="col-sm-2">
                    <label>Approve Status</label>
                    <select id="ApproveStatus" class="form-control input-sm" style="width: 100%" runat="server">
