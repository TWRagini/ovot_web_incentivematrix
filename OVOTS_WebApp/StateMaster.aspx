<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StateMaster.aspx.cs" Inherits="OVOTS_WebApp.StateMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 width:50px;
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto';margin-top:30px">State Master</h2>
        <div style="width: 100%; ">
            ...
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px; background-color: #D8D8D8; overflow: auto">
                ...
                <table class="imagetable" id="StateMasterTbl" style="width:100%; background-color: whitesmoke; font-size: 12px">
                ...
                <table class="imagetable" id="StateMasterTblExl" style="width: 100%; display: none; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                        <th style="">State Code</th>
                        <th style="">State Name</th>
                            ...
                            <div class="modal-content">
                                <div class="modal-body" id="ModelContent">
                                    <div class="" style="padding: 10px;">
                                        <h4 style="text-align: center; margin-left: 0; font-family: 'Roboto'">State Details</h4>
                                        <div style="height: 100%">
                                            <div class="form-group; col-sm-12">
                                                <input type="hidden" id="HDStateCode" value="0" />
                                                <div class="col-sm-4">
                                                    <label>State Name</label>
                                                    <input type="text" class="form-control input-sm" id="StateName" maxlength="150" placeholder="State Name" />
                                                </div>
    ...
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/Pages/StateMasterJS.js"></script>
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/bootstrap.js"></script>
    <script>
        function ShowMsg() {
