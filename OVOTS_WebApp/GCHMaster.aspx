<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GCHMaster.aspx.cs" Inherits="OVOTS_WebApp.GCHMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto';margin-top:30px">GCH Master</h2>
        <div style="width: 100%; ">
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px">
                <div class="col-sm-2">
                    ...
                    <select id="ddlFilterType" class="form-control input-sm" style="width: 100%">
                        ...
                        <option value="GCH">GCH Name</option>
            ...
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px; background-color: #D8D8D8; overflow: auto">
                ...
                <table class="imagetable" id="GCHMasterTbl" style="width: 150%; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                        <th style="" class='noExl'>Action</th>
                        <th style="">GCH Code</th>
                ...
                <table class="imagetable" id="GCHMasterTblExl" style="width: 100%; display: none; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                         <th style="">GCH Code</th>
                        <th style="">GCH Name</th>
                        <th style="">Mobile No</th>
                            ...
                            <div class="modal-content">
                                <div class="modal-body" id="ModelContent">
                                    <div class="" style="padding: 10px;">
                                        <h4 style="text-align: center; margin-left: 0; font-family: 'Roboto'">GCH Details</h4>
                                        <div style="height: 100%">
                                            <div class="form-group; col-sm-12">
                                                <input type="hidden" id="HDGCHCode" value="0" />
                                                <div class="col-sm-4">
                                                    <label>GCH Name</label>
                                                    <input type="text" class="form-control input-sm" id="GCHName" maxlength="150" placeholder="GCH Name" />
                                                </div>
                                                <div class="col-sm-4">
    ...
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/Pages/GCHMasterJS.js"></script>
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/bootstrap.js"></script>
    <script>
        function ShowMsg() {
