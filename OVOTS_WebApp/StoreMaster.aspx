<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StoreMaster.aspx.cs" Inherits="OVOTS_WebApp.StoreMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto';margin-top:30px">Store Master</h2>
        <div style="width: 100%; ">
            ...
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px; background-color: #D8D8D8; overflow: auto">
                ...
                <table class="imagetable" id="StoreMasterTbl" style="width: 100%; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                        <th style="" class='noExl'>Action</th>
                        <th style="">Store Code</th>
                ...
                <table class="imagetable" id="StoreMasterTblExl" style="width: 100%; display: none; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                         <th style="">Store Code</th>
                        <th style="">Store Name</th>
                        <th style="">Mobile No</th>
                            ...
                            <div class="modal-content">
                                <div class="modal-body" id="ModelContent">
                                    <div class="" style="padding: 10px;">
                                        <h4 style="text-align: center; margin-left: 0; font-family: 'Roboto'">Store Details</h4>
                                        <div style="height: 100%">
                                            <div class="form-group; col-sm-12">
                                                <input type="hidden" id="HDStoreCode" value="0" />
                                                <div class="col-sm-4">
                                                    <label>Store Name</label>
                                                    <input type="text" class="form-control input-sm" id="StoreName" maxlength="150" placeholder="Store Name" />
                                                </div>
                                                <div class="col-sm-4">
    ...
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/Pages/StoreMasterJS.js"></script>
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/bootstrap.js"></script>
    <script>
        function ShowMsg() {
