<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ASMMaster.aspx.cs" Inherits="OVOTS_WebApp.ASMMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto';margin-top:30px">ASM Master</h2>
        <div style="width: 100%; ">
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px">
                <div class="col-sm-2">
                    ...
                    <select id="ddlFilterType" class="form-control input-sm" style="width: 100%">
                        ...
                        <option value="ASM">ASM Name</option>
            ...
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px; background-color: #D8D8D8; overflow: auto">
                ...
                <table class="imagetable" id="ASMMasterTbl" style="width: 100%; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                        <th style="" class='noExl'>Action</th>
                        <th style="">ASM Code</th>
                        <th style="">ASM Name</th>
                        <th style="">Mobile No</th>
                         <th style="">Email No</th>
                        <th style="">State</th>
                ...
                <table class="imagetable" id="ASMMasterTblExl" style="width: 100%; display: none; background-color: whitesmoke; font-size: 12px">
                    <tr style="background-color: #D8D8D8">
                         <th style="">ASM Code</th>
                        <th style="">ASM Name</th>
                        <th style="">Mobile No</th>
                            ...
                            <div class="modal-content">
                                <div class="modal-body" id="ModelContent">
                                    <div class="" style="padding: 10px;">
                                        <h4 style="text-align: center; margin-left: 0; font-family: 'Roboto'">ASM Details</h4>
                                        <div style="height: 100%">
                                            <div class="form-group; col-sm-12">
                                                <input type="hidden" id="HDASMCode" value="0" />
                                                <div class="col-sm-4">
                                                    <label>ASM Name</label>
                                                    <input type="text" class="form-control input-sm" id="ASMName" maxlength="150" placeholder="ASM Name" />
                                                </div>
                                                <div class="col-sm-4">
    ...
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/Pages/ASMMasterJS.js"></script>
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/bootstrap.js"></script>
    <script>
        function ShowMsg() {
