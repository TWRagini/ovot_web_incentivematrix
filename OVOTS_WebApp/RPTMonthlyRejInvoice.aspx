<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RPTMonthlyRejInvoice.aspx.cs" Inherits="OVOTS_WebApp.RPTMonthlyRejInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto'" runat="server" id="lblheading">Date Wise Rejected Invoice</h2>
