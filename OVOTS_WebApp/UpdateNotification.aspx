<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UpdateNotification.aspx.cs" Inherits="OVOTS_WebApp.UpdateNotification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        <h2 style="text-align: center; margin-left: 0; font-family: 'Roboto';margin-left:30px">Update & Notification</h2>
        <div style="width: 100%; ">
            ...
            <div class="form-group; col-sm-12" style="border: 1px solid black; padding: 20px; background-color: #D8D8D8">
                ...
                <table class="imagetable" id="DistributerMasterTbl" style="width: 100%; background-color: whitesmoke; font-size: 12px">
                    ...
                    <tr style="background-color: #D8D8D8">
                        ...
                        <th style="">Update Code</th>
                       
                         <th style="">Short Name</th>
                        <th style="">Content Type</th>
                            ...
                            <div class="modal-content">
                                <div class="modal-body" id="ModelContent">
                                    <div class="" style="padding: 10px;">
                                        <h4 style="text-align: center; margin-left: 0; font-family: 'Roboto'">Update & Notification Details</h4>
                                            ...
                                            <div class="form-group; col-sm-12">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="file" id="flpFilePath" />
                                                     <a id="aFilePath" style="display:none">View File</a>
                                                </div>
                                                <div class="col-sm-7">
                                                    <label>Content</label>
                                                    <textarea class="form-control" placeholder="Content" id="Content" maxlength="200" cols="2" rows="2" style="max-width:100%"></textarea>
                                                </div>
    ...
    <script src="Scripts/jquery-3.4.1.js"></script>
    <script src="Scripts/UpdateJs.js?vr=1.0"></script>
