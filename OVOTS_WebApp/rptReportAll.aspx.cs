...
namespace OVOTS_WebApp
{
    public partial class rptReportAll : System.Web.UI.Page
    {
        ...
        private void BindReportGrid()
        {
            ...
            DSGet = dal.GetReport(FiltrType, Filtervalue, strFrom, strTo, ReportTyepe, ReportName);
        ...
        protected void GenExcel_ServerClick(object sender, EventArgs e)
        {
            ...
            dsExcel = dal.GetReport(FiltrType, Filtervalue, strFrom, strTo, ReportTyepe, ReportName);
